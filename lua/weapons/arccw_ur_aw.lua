...
SWEP.Trivia_Desc = "The Arctic Warfare, a heavy, purpose-designed rifle for extreme-range combat under extreme climates. Few targets can stand up to a well-placed shot, but its long bolt pull and reload time are an encumbrance outside of its preferred environment.\n\nOne shot. One kill. You know the routine."
...
SWEP.Animations = {
    ...
    ["reload_338"] = {
        ...
        SoundTable = {
            ...
            {s = testpath .. "magrel.ogg", 	t = 0.4},
            {s = testpath .. "magout_empty.ogg",          t = 1.1},
            {s = common .. "magpouch.ogg",           t = 1.6},
            {s = rottle,    t = 1.6},
            {s = testpath .. "struggle.ogg",   t = 2.25},
            {s = testpath .. "magin.ogg",   t = 2.55},
            {s = testpath .. "magtap.ogg",   t = 3.35},
            {s = rottle,    t = 3.5},
            {s = ratel,   t = 3.8},
        },
    },
    ...
    ["reload_empty_10"] = {
        ...
        SoundTable = {
            ...
            {s = rottle,    t = 2.2},
            {s = testpath .. "magdrop_metal.ogg",          t = 2.4},
            {s = testpath .. "struggle.ogg",   t = 3},
            {s = testpath .. "magin.ogg",   t = 3.2},
            {s = testpath .. "magtap.ogg",   t = 3.95},
            {s = rottle,    t = 4.2},
            {s = ratel,   t = 4.5},
            {s = testpath .. "boltforward_reload.ogg",     t = 4.55},
            {s = testpath .. "boltdown.ogg",        t = 4.95},
        },
    },
    ["reload_empty_338"] = {
        ...
        SoundTable = {
            ...
            {s = testpath .. "magrel.ogg", 	t = 1.1},
            {s = rottle,    t = 1.8},
            {s = testpath .. "magout_empty.ogg",          t = 1.85},
            {s = common .. "magpouch.ogg",           t = 2.3},
            {s = rottle,    t = 2.3},
            {s = testpath .. "magdrop_metal.ogg",          t = 2.45},
            {s = testpath .. "struggle.ogg",   t = 2.9},
            {s = testpath .. "magin.ogg",   t = 3.1},
            {s = testpath .. "magtap.ogg",   t = 3.85},
            {s = rottle,    t = 4.1},
            {s = ratel,   t = 4.3},
            {s = testpath .. "boltforward_reload.ogg",     t = 4.5},
            {s = testpath .. "boltdown.ogg",        t = 4.9},
        },
    },
    ["reload_empty_10_338"] = {
        ...
        SoundTable = {
            ...
            {s = common .. "magpouch.ogg",           t = 2.2},
            {s = rottle,    t = 2.2},
            {s = testpath .. "magdrop_metal.ogg",          t = 2.35},
            {s = testpath .. "struggle.ogg",   t = 3},
            {s = testpath .. "magin.ogg",   t = 3.15},
            {s = testpath .. "magtap.ogg",   t = 3.95},
            {s = rottle,    t = 4.2},
            {s = ratel,   t = 4.5},
            {s = testpath .. "boltforward_reload.ogg",     t = 4.55},
