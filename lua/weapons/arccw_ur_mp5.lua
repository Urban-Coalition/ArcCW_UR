...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        SoundTable = {
            {s = "weapons/arccw_ud/common/cloth_1.ogg", 	t = 0/30},
            {s = "weapons/arccw_ur/mp5/magout.ogg", 	t = 13/30},
            {s = "weapons/arccw_ud/common/cloth_4.ogg", 	t = 20/30},	
            {s = "weapons/arccw_ur/mp5/magin.ogg", 	t = 36/30},
            {s = "weapons/arccw_ud/common/cloth_3.ogg", 	t = 40/30},	
            {s = "weapons/arccw_ud/common/shoulder.ogg", 	t = 70/30},	
					},
        LHIK = true,
        LHIKIn = 0.3,
        LHIKOut = 0.5,
    ...
    ["reload_empty"] = {
        ...
        SoundTable = {
            ...
            {s = "weapons/arccw_ud/common/cloth_2.ogg", 	t = 30/30},		
            {s = "weapons/arccw_ur/mp5/magin.ogg", 	t = 52/30},
            {s = "weapons/arccw_ud/common/cloth_4.ogg", 	t = 55/30},
            {s = "weapons/arccw_ud/common/cloth_3.ogg", 	t = 75/30},
            {s = "weapons/arccw_ur/mp5/chamber.ogg", 	t = 80/30},	
            {s = "weapons/arccw_ud/common/shoulder.ogg", 	t = 95/30},						
					},
        LHIK = true,
        LHIKIn = 0.3,
        LHIKOut = 0.5,
