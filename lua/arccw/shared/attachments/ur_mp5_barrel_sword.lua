...
att.Description = "Aftermarket upper receiver that reduces muzzle rise using a weighted barrel shroud. The extra weight makes the weapon harder to aim with."
att.Desc_Cons = {
    "uc.nomuzzle"
}
att.AutoStats = true
